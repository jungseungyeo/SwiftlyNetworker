...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/linsaeng/SwiftlyNetworker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'linsaeng' => 'duwjdtmd91@gmail.com' }
  s.source           = { :git => 'https://github.com/linsaeng/SwiftlyNetworker.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'SwiftlyNetworker' => ['SwiftlyNetworker/Assets/*.png']
  # }
